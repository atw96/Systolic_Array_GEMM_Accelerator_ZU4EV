...
//
// ── 默认 ARRAY_SIZE=8 的具体寄存器地址表（供软件/文档参考）─────
//   0x00        CTRL_REG
//   0x04        STATUS_REG
//   0x08~0x24   RESULT_0~7      (8 个)
//   0x28~0x44   DATA_IN_0~7     (8 个)
//   0x48~0x144  WEIGHT_00~77    (64 个，行主序 B[i][j] @ 0x48+(i*8+j)*4)
//   总计 82 个寄存器，328 字节（远小于分配的 64KB 地址空间）
//
...
module axi_ctrl_top #(
    parameter integer ARRAY_SIZE        = 8,  // 【优化】脉动阵列规模，原固定 4，现参数化默认 8
