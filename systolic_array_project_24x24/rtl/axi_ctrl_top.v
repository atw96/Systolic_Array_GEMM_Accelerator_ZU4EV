...
//
// ── 默认 ARRAY_SIZE=24 的具体寄存器地址表（供软件/文档参考）─────
//   0x00        CTRL_REG
//   0x04        STATUS_REG
//   0x08~0x64   RESULT_0~23      (24 个)
//   0x68~0xC4   DATA_IN_0~23     (24 个)
//   0xC8~0x9C4  WEIGHT_00~2323    (576 个，行主序 B[i][j] @ 0xC8+(i*24+j)*4)
//   总计 626 个寄存器，2504 字节（仍小于分配的 64KB 地址空间）
//
...
module axi_ctrl_top #(
    parameter integer ARRAY_SIZE        = 24,  // 【优化】脉动阵列规模，原固定 4，本版本默认 24
